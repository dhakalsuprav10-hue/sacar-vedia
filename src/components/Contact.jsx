        ...
        <div className="contact-glass-card">
          ...
          <div className="contact-header">
            ...
            <p className="contact-subtitle">
              ...
              Reach out directly to <strong>Sacar Vedia Company</strong> via email, WhatsApp, or send a brief below.
            </p>
          </div>
          ...
          {onStartProject && (
            <div className="contact-modal-trigger-wrap">
              <button
                type="button"
          ...
          <div className="contact-social-section">
            <span className="social-row-label">OR CONNECT ON SOCIAL NETWORKS</span>
          ...
          <div className="contact-form-container">
            ...
            <div className="form-heading-group">
              <span className="form-eyebrow-chip">
                <Sparkles size={11} /> DIRECT INBOX FORM
              </span>
              <h3 className="embedded-form-title">SEND AN INQUIRY OR PROJECT BRIEF</h3>
              <p className="embedded-form-desc">
